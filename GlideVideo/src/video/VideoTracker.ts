...
export class VideoTracker {
	...
	public debouncedEvaluate: (() => void) & { cancel?: () => void };
	 ...
	 */
	private readonly watched = new Set<HTMLVideoElement>();
		...
		mutations.forEach((mutation) => {
			if (mutation.type === "attributes") {
				...
				if (
					...
					(this.store.activeVideo && target.contains?.(this.store.activeVideo))
				) {
